...
/**
 * Vertex coordinates and normal attributes.
 */
public class NormalColorMesh extends AbstractMesh {
	
	public static final int BYTES_PER_FLOAT = 4;

	public NormalColorMesh(Renderer renderer, VertexData vertexData, NormalColorShader shaderProgram, boolean useVBOs) {
		super(renderer, vertexData, shaderProgram, useVBOs);
	}
	
	public NormalColorMesh(Renderer renderer, VertexData vertexData, NormalColorShader shaderProgram) {
