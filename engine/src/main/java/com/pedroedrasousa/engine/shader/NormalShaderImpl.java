 ...
 */
public class NormalShaderImpl extends AbstractShaderProg implements NormalShader {

	public static final String COORDS_ATTRIB_NAME		= "aVertPos";
	public static final String NORMAL_ATTRIB_NAME		= "aNormal";
	
	public NormalShaderImpl(Renderer renderer, int vertexResourceId, int fragmentResourceId) {
