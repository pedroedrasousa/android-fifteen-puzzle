 ...
 */
public class NormalColorShaderImpl extends AbstractShaderProg implements NormalColorShader {

	public static final String COORDS_ATTRIB_NAME		= "aVertPos";
	public static final String NORMAL_ATTRIB_NAME		= "aNormal";
	public static final String COLOR_ATTRIB_NAME		= "uColor";
	
	
	public NormalColorShaderImpl(Renderer renderer, int vertexResourceId, int fragmentResourceId) {
	...
	public void setColor(Vec3 color) {
		uniform3f("uColor", color.x, color.y, color.z);
	}
